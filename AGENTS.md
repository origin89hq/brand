...
- Check that palette changes originate in `palette/src/` and regenerate their
  outputs. Preserve contrast guarantees, public exports, and consumer imports.
- Preserve editable identity and Buddy sources alongside their derivatives.
  Review and ordinary validation must not invoke Blender, release publishing,
  or package upgrades in consumers.
