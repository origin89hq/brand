...
export const HERITAGE = [
  ...
  { name: "mtq-green-lit", value: "#0a7d49", why: "The same plate in daylight." },
  {
    name: "mtq-blue",
    value: "#2b4a97",
    why: "The P-89 structure plate. Same value as action, deliberately: the control is the plate.",
  },
];
...
export const QUALITY = [
  ...
  { state: "estimated", token: "info", channel: "leading ≈", note: "Derived. The ≈ is mandatory." },
  {
    state: "stale",
    token: "muted",
    channel: "dashed rule + age",
    note: "Last known, and how long ago.",
  },
  {
    state: "missing",
    token: "faint",
    channel: "em-dashes",
    note: "Never a number. A missing probe is not 0.0 °C.",
  },
];
