...
| `situations/` | The reserve scene that places Buddy at a site, and its build script. |
...
studio and the reserve scene, about 245 MB. Clone with
...
design guide and the terms. The latest one is always at
https://github.com/origin89hq/brand/releases/latest/download/origin89-brand-kit.zip,
which is the link the website uses.
